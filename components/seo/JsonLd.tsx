...
export function OrganizationJsonLd() {
  const data = {
    ...
    logo: 'https://shapehive.in/novalis-logo.png',
    description: 'Luxury fragrance brand from Dubai, UAE, crafting exclusive perfumes with an authentic Emirati soul using premium ingredients like oud, musk, amber, and rare botanicals.',
    ...
    sameAs: ['https://wa.me/971563554303', 'https://instagram.com/novalis.ae', 'https://tiktok.com/@novalis.ae'],
    contactPoint: {
      '@type': 'ContactPoint',
      telephone: '+971563554303',
...
export function LocalBusinessJsonLd({ currency = 'AED' }: { currency?: string }) {
  const data = {
    ...
    name: 'Novalis',
    image: 'https://shapehive.in/novalis-logo.png',
    url: 'https://shapehive.in',
    telephone: '+971563554303',
    email: 'info@novalis.ae',
    description: 'Luxury fragrance brand from Dubai, UAE, crafting exclusive perfumes with an authentic Emirati soul. Premium oud, musk, and amber compositions.',
    address: {
      '@type': 'PostalAddress',
      addressLocality: 'Dubai',
