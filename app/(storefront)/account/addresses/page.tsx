      ...
      <div className="bg-white rounded-2xl w-full max-w-md max-h-[90vh] overflow-y-auto p-5 shadow-xl">
        ...
        <div className="flex gap-3 mt-5">
          ...
          <button
            ...
            className="flex-1 py-2.5 rounded-xl bg-[#D4AFB9] text-white text-sm font-semibold hover:bg-[#B8985D] transition-colors disabled:opacity-50"
          >
        ...
        <>
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#D4AFB9] text-white text-xs font-semibold hover:bg-[#B8985D] transition-colors"
            >
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-gray-100 transition-colors text-gray-400 hover:text-[#D4AFB9]"
                      ...
                      {addr.id !== 'billing' && addr.id !== 'shipping' && (
                        <button
                          ...
                          className="p-1.5 rounded-lg hover:bg-red-50 transition-colors text-gray-400 hover:text-[#D4AFB9]"
