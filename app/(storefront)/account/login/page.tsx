      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-[#FAF6F0] rounded-2xl flex items-center justify-center mx-auto mb-4">
            <svg className="w-8 h-8 text-[#742938]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-2.21 0-4 2.015-4 4.5S9.79 17 12 17s4-2.015 4-4.5S14.21 8 12 8zm0 0V3m0 14v4" /></svg>
          </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-gray-100 p-6 space-y-4 shadow-sm">
          ...
          <div className="flex items-center justify-end -mt-2">
            <Link href="/account/forgot-password" className="text-xs text-[#742938] hover:underline font-semibold">
              Forgot password?
            </Link>
          </div>
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-[#666]">
            ...
            <Link href="/account/register" className="text-[#742938] font-semibold hover:underline">
              Create Account
            </Link>
          </p>
