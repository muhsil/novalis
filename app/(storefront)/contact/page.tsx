...
export const metadata: Metadata = {
  title: 'Contact Us',
  description: 'Get in touch with ShapeHive. We\'re here to help with your balloon orders, questions, and celebrations in Dubai.',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
        {CONTACT_METHODS.map((m) => (
          <div key={m.label} className="bg-white rounded-lg border border-[#f0f0f0] p-4 flex items-start gap-3">
            <span className="text-[#E53935]">{CONTACT_ICONS[m.key]}</span>
            <div>
