      ...
      <footer className="bg-white border-t border-[#f0f0f0] max-md:hidden">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 py-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <Link href="/" className="flex items-center gap-2 mb-3">
                ...
                <span className="font-bold text-lg text-[#E53935]">ShapeHive</span>
              </Link>
          ...
          <div className="border-t border-[#f0f0f0] mt-10 pt-6 text-center">
            <p className="text-[#999] text-xs">&copy; {new Date().getFullYear()} ShapeHive. All rights reserved.</p>
          </div>
        </div>
      </footer>
      ...
      <footer className="md:hidden bg-white border-t border-[#f0f0f0] mb-14 px-4 py-4">
        <div className="text-center">
          <Link href="/" className="inline-flex items-center gap-1.5 mb-2">
            ...
            <span className="font-bold text-sm text-[#E53935]">ShapeHive</span>
          </Link>
          ...
          <p className="text-[#ccc] text-[10px] mt-2">&copy; {new Date().getFullYear()} ShapeHive</p>
        </div>
      </footer>
