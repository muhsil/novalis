          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div>
              <Link href="/" className="flex items-center gap-2 mb-3">
                <svg className="w-6 h-6 text-[#C9A96E]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 8c-2.21 0-4 2.015-4 4.5S9.79 17 12 17s4-2.015 4-4.5S14.21 8 12 8zm0 0V3m0 14v4" /></svg>
                <span className="font-bold text-lg text-[#C9A96E]">Novalis</span>
              </Link>
              <p className="text-[#999] text-sm leading-relaxed">
                Luxury Arabic perfumes and exquisite fragrances crafted with the finest ingredients. Inspired by Emirati heritage.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-2">
                {[
                  ...
                  <Link key={link.href} href={link.href} className="text-[#666] text-sm hover:text-[#C9A96E] transition-colors">
                    {link.label}
                  </Link>
                ))}
              </div>
      ...
      <footer className="md:hidden bg-white border-t border-[#f0f0f0] mb-14 px-4 py-4">
        <div className="text-center">
          <Link href="/" className="inline-flex items-center gap-1.5 mb-2">
            <svg className="w-4 h-4 text-[#C9A96E]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M12 8c-2.21 0-4 2.015-4 4.5S9.79 17 12 17s4-2.015 4-4.5S14.21 8 12 8zm0 0V3m0 14v4" /></svg>
            <span className="font-bold text-sm text-[#C9A96E]">Novalis</span>
          </Link>
          <p className="text-[#999] text-[10px] mb-2">Luxury Arabic Perfumes & Fragrances</p>
          <div className="flex items-center justify-center gap-3 text-xs text-[#666] flex-wrap">
            ...
            <span className="text-[#e8e8e8]">|</span>
            <a href="https://wa.me/971563554303" className="hover:text-[#C9A96E]">WhatsApp</a>
          </div>
