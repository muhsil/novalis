...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'How can I contact support?', a: 'Reach us on WhatsApp at +971 56 355 4303 or email hello@novalis.ae. We typically respond within 30 minutes during business hours.' },
    ],
  },
];
    ...
    <div className="max-w-4xl mx-auto px-4 max-md:px-3 py-8 max-md:py-5 max-md:pb-20">
      ...
      <div className="bg-[#FFEBEE] rounded-lg p-6 max-md:p-4 text-center mt-6">
        ...
        <div className="flex justify-center gap-3">
          ...
          <a href="mailto:hello@novalis.ae" className="bg-white text-[#E53935] border border-[#E53935] font-semibold text-sm px-4 py-2 rounded-lg hover:bg-[#FFEBEE] transition-colors inline-flex items-center gap-1">
