...
export const metadata: Metadata = {
  title: 'FAQ',
  description: 'Frequently asked questions about ShapeHive. Learn about ordering, delivery, payment, and more.',
    ...
    <div className="max-w-4xl mx-auto px-4 max-md:px-3 py-8 max-md:py-5 max-md:pb-20">
      ...
      <div className="bg-[#FFEBEE] rounded-lg p-6 max-md:p-4 text-center mt-6">
        ...
        <div className="flex justify-center gap-3">
          ...
          <a href="mailto:hello@shapehive.in" className="bg-white text-[#E53935] border border-[#E53935] font-semibold text-sm px-4 py-2 rounded-lg hover:bg-[#FFEBEE] transition-colors inline-flex items-center gap-1">
